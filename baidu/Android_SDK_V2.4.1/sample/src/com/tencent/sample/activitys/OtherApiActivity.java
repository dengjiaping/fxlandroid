...
public class OtherApiActivity extends BaseActivity implements OnClickListener {
			...
			builder.setPositiveButton("确定",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							String reqnum = inputServer.getText()
									.toString();// 请求个数(1-10)
							int num;
							try{
	...
	private void onClickCheckLogin() {
		IUiListener listener = new BaseUIListener(this,"验证token");
		MainActivity.mTencent.login(this, SCOPE, listener);
	}
