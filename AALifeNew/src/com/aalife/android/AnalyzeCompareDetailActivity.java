...
public class AnalyzeCompareDetailActivity extends Activity {
	...
	protected void setListData(String date) {		
		...
		itemAccess.close();
		adapter = new SimpleAdapter(this, list, R.layout.list_analyzecompare_detail, new String[] { "itemname", "countcur", "pricecur", "countprev", "priceprev" }, new int[] { R.id.tv_analyze_itemname, R.id.tv_analyze_countcur, R.id.tv_analyze_pricecur, R.id.tv_analyze_countprev, R.id.tv_analyze_priceprev });
