...
public class MyCalcView extends LinearLayout {
	...
	public MyCalcView(Context context) {
		...
		View popView = inflater.inflate(R.layout.calclayout, null);
	...
	private Boolean hasDian(String s) {
		if (s.length() > 0) {
			...
			// System.out.println(r.lastIndexOf('.'));
			if (!r.equals("")) {
				if (r.lastIndexOf('.') < 0) {
					return true;
				}
	...
	private void getResult(String s) {
		if (s.length() > 0) {
			...
			// System.out.println("aa " + numList);
			// System.out.println("aa " + signList);
			...
			// System.out.println("bb " + numList);
			// System.out.println("bb " + signList);
			...
			// System.out.println("cc " + numList);
			// System.out.println("cc " + signList);
